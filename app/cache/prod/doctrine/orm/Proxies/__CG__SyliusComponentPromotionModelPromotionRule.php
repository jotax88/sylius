 ...
 */
class PromotionRule extends \Sylius\Component\Promotion\Model\PromotionRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PromotionRule $proxy) {
