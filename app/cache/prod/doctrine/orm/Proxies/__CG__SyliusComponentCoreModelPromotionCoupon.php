 ...
 */
class PromotionCoupon extends \Sylius\Component\Core\Model\PromotionCoupon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'perCustomerUsageLimit', 'id', 'code', 'usageLimit', 'used', 'promotion', 'expiresAt', 'createdAt', 'updatedAt'];
        }
