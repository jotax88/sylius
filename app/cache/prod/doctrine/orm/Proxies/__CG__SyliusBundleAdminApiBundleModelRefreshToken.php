 ...
 */
class RefreshToken extends \Sylius\Bundle\AdminApiBundle\Model\RefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'client', 'token', 'expiresAt', 'scope', 'user'];
        }
