 ...
 */
class Channel extends \Sylius\Component\Core\Model\Channel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'baseCurrency', 'defaultLocale', 'defaultTaxZone', 'taxCalculationStrategy', 'currencies', 'locales', 'themeName', 'contactEmail', 'skippingShippingStepAllowed', 'skippingPaymentStepAllowed', 'accountVerificationRequired', 'id', 'code', 'name', 'description', 'hostname', 'color', 'createdAt', 'updatedAt', 'enabled'];
        }
