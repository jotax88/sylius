...
namespace Proxies\__CG__\Sylius\Bundle\AdminApiBundle\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AuthCode extends \Sylius\Bundle\AdminApiBundle\Model\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'redirectUri', 'id', 'client', 'token', 'expiresAt', 'scope', 'user'];
        }
