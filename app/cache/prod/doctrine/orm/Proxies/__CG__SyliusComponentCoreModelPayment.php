 ...
 */
class Payment extends \Sylius\Component\Core\Model\Payment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'order', 'id', 'method', 'currencyCode', 'amount', 'state', 'details', 'createdAt', 'updatedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function getMethod(): ?\Sylius\Component\Payment\Model\PaymentMethodInterface
    {
     ...
     * {@inheritDoc}
     */
    public function setMethod(?\Sylius\Component\Payment\Model\PaymentMethodInterface $method): void
    {
