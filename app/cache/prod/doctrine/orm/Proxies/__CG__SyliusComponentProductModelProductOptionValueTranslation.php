 ...
 */
class ProductOptionValueTranslation extends \Sylius\Component\Product\Model\ProductOptionValueTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'value', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductOptionValueTranslation $proxy) {
