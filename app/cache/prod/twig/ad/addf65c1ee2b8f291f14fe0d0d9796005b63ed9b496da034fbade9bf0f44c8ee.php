...
class __TwigTemplate_438825704604f7960365d9bd8b12c031cea28b98dd73f0b14912b9aa01dc5332 extends Twig_Template
{
    private $source;
...
";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "user", array()), "plainPassword", array()), "first", array()), 'row');
        echo "
";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "user", array()), "plainPassword", array()), "second", array()), 'row');
        echo "
";
    }
    ...
    {
        return array (  58 => 11,  54 => 10,  50 => 9,  46 => 8,  42 => 7,  38 => 6,  33 => 4,  29 => 3,  23 => 1,);
    }

    public function getSourceContext()
    {
        return new Twig_Source("", "@SyliusShop/Register/_form.html.twig", "C:\\xampp\\htdocs\\Proyectos Git\\silyus\\acme\\vendor\\sylius\\sylius\\src\\Sylius\\Bundle\\ShopBundle/Resources/views/Register/_form.html.twig");
    }
}
