...
return $this->services['hateoas.expression.link'] = new \Hateoas\Expression\LinkExpressionFunction(($this->services['hateoas.helper.link'] ?? $this->load('getHateoas_Helper_LinkService.php')));
