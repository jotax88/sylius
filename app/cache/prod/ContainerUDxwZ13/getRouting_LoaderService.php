...
$a = ($this->privates['file_locator'] ?? $this->privates['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->targetDirs[2].'/Resources'), array(0 => $this->targetDirs[2])));
$b = ($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService());
$c = ($this->privates['controller_name_converter'] ?? $this->privates['controller_name_converter'] = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser(($this->services['kernel'] ?? $this->get('kernel', 1))));
...
$f->addLoader(new \Sylius\Bundle\ResourceBundle\Routing\ResourceLoader(($this->privates['sylius.resource_registry'] ?? $this->getSylius_ResourceRegistryService()), new \Sylius\Bundle\ResourceBundle\Routing\RouteFactory()));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\DirectoryRouteLoader($a, $d));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $a, $c, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($b, new \FOS\RestBundle\Request\ParamReader($b), new \FOS\RestBundle\Inflector\DoctrineInflector(), true, array('json' => false, 'xml' => false, 'html' => true), true), $b), NULL));
