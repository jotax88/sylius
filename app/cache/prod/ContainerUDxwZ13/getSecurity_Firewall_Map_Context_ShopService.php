...
$c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, ($this->services['sylius.handler.shop_user_logout'] ?? $this->load('getSylius_Handler_ShopUserLogoutService.php')), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'sylius_shop_logout'));
