...
// Returns the private 'security.authentication.provider.rememberme.shop' shared service.
...
return $this->privates['security.authentication.provider.rememberme.shop'] = new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider(($this->privates['security.user_checker'] ?? $this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker()), $this->getEnv('SYLIUS_SECRET'), 'shop');
