...
$c->addPath(($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/views'), '!Swiftmailer');
$c->addPath(($this->targetDirs[2].'/Resources/TwigBundle/views'), 'Twig');
...
$g = ($this->privates['debug.stopwatch'] ?? $this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true));
$h = ($this->services['knp_menu.matcher'] ?? $this->load('getKnpMenu_MatcherService.php'));

$i = new \Knp\Menu\Util\MenuManipulator();

$j = new \Pagerfanta\View\DefaultView();

$k = new \Pagerfanta\View\TwitterBootstrapView();

$l = new \Pagerfanta\View\TwitterBootstrap3View();

$m = new \Pagerfanta\View\TwitterBootstrap4View();

$n = new \Pagerfanta\View\SemanticUiView();

$o = new \Pagerfanta\View\ViewFactory();
$o->add(array('default' => $j, 'default_translated' => new \WhiteOctober\PagerfantaBundle\View\DefaultTranslatedView($j, $d), 'twitter_bootstrap' => $k, 'twitter_bootstrap3' => $l, 'twitter_bootstrap4' => $m, 'semantic_ui' => $n, 'twitter_bootstrap4_translated' => new \WhiteOctober\PagerfantaBundle\View\TwitterBootstrap4TranslatedView($m, $d), 'twitter_bootstrap3_translated' => new \WhiteOctober\PagerfantaBundle\View\TwitterBootstrap3TranslatedView($l, $d), 'twitter_bootstrap_translated' => new \WhiteOctober\PagerfantaBundle\View\TwitterBootstrapTranslatedView($k, $d), 'semantic_ui_translated' => new \WhiteOctober\PagerfantaBundle\View\SemanticUiTranslatedView($n, $d)));

$p = new \Symfony\Bridge\Twig\AppVariable();
$p->setEnvironment('prod');
$p->setDebug(false);
if ($this->has('security.token_storage')) {
    $p->setTokenStorage(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()));
}
...
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($this->privates['debug.file_link_formatter'] ?? $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)), $this->targetDirs[2], 'UTF-8'));
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\RoutingExtension($f));
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\YamlExtension());
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\StopwatchExtension($g, false));
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\ExpressionExtension());
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\HttpKernelExtension());
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\HttpFoundationExtension($e, ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService())));
...
})), 'twig'), ($this->privates['knp_menu.menu_provider.chain'] ?? $this->load('getKnpMenu_MenuProvider_ChainService.php')), $i, $h), $h, $i));
...
$instance->addExtension(new \WhiteOctober\PagerfantaBundle\Twig\PagerfantaExtension('default', $o, $f, $e));
...
$instance->addGlobal('sylius_meta', array('version' => '1.2.4'));
