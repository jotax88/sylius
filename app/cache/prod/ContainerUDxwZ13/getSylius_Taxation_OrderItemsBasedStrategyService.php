...
// Returns the public 'sylius.taxation.order_items_based_strategy' shared service.
...
return $this->services['sylius.taxation.order_items_based_strategy'] = new \Sylius\Bundle\CoreBundle\Taxation\Strategy\TaxCalculationStrategy('order_items_based', array(0 => ($this->services['sylius.taxation.order_items_taxes_applicator'] ?? $this->load('getSylius_Taxation_OrderItemsTaxesApplicatorService.php')), 1 => ($this->services['sylius.taxation.order_shipment_taxes_applicator'] ?? $this->load('getSylius_Taxation_OrderShipmentTaxesApplicatorService.php'))));
