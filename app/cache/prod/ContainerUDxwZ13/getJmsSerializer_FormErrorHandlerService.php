...
return $this->services['jms_serializer.form_error_handler'] = new \FOS\RestBundle\Serializer\Normalizer\FormErrorHandler(($this->services['translator'] ?? $this->getTranslatorService()), 'validators');
