...
$b = new \Metadata\MetadataFactory(new \Metadata\Driver\DriverChain(array(0 => new \Hateoas\Configuration\Metadata\Driver\YamlDriver($a), 1 => new \Hateoas\Configuration\Metadata\Driver\XmlDriver($a), 2 => new \Hateoas\Configuration\Metadata\Driver\ExtensionDriver(new \Hateoas\Configuration\Metadata\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()))))), 'Metadata\\ClassHierarchyMetadata', false);
